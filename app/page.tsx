...
import CodeIcon from "@material-ui/icons/Person"
...
export default function Home() {
  ...
  <div className="w-full md:w-1/2 lg:w-1/3 p-4">
    <div className="flex items-center mb-2  border-2 rounded-lg border-gray-300">
      <span className="text-blue-500 text-3xl mr-2"><CodeIcon className="m-2 border-2 border-gray-300 rounded-lg" style={{fontSize: "2.5rem"}}/></span>
  ...
  <div className="w-full md:w-1/2 lg:w-1/3 p-4">
    <div className="flex items-center mb-2  border-2 rounded-lg border-gray-300">
      <span className="text-blue-500 text-3xl mr-2"><BuildIcon className="m-2 border-2 border-gray-300 rounded-lg" style={{fontSize: "2.5rem"}}/></span>
  ...
  <div className="w-full md:w-1/2 lg:w-1/3 p-4">
    <div className="flex items-center mb-2  border-2 rounded-lg border-gray-300">
      <span className="text-blue-500 text-3xl mr-2"><PeopleIcon className="m-2 border-2 border-gray-300 rounded-lg" style={{fontSize: "2.5rem"}}/></span>
  ...
  <div className="w-full md:w-1/2 lg:w-1/3 p-4">
    <div className="flex items-center mb-2  border-2 rounded-lg border-gray-300">
      <span className="text-blue-500 text-3xl mr-2"><ApartmentIcon className="m-2 border-2 border-gray-300 rounded-lg" style={{fontSize: "2.5rem"}}/></span>
  ...
  <div className="w-full md:w-1/2 lg:w-1/3 p-4">
    <div className="flex items-center mb-2  border-2 rounded-lg border-gray-300">
      <span className="text-blue-500 text-3xl mr-2"><LaptopIcon className="m-2 border-2 border-gray-300 rounded-lg" style={{fontSize: "2.5rem"}}/></span>
  ...
  <div className="w-full md:w-1/2 lg:w-1/3 p-4">
    <div className="flex items-center mb-2  border-2 rounded-lg border-gray-300">
      <span className="text-blue-500 text-3xl mr-2"><PersonIcon className="m-2 border-2 border-gray-300 rounded-lg" style={{fontSize: "2.5rem"}}/></span>
