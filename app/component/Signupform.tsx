    ...
    <>
      ...
      /* -------------------------------------------------------------------------- */}
          ...
          {Error && <div id="alert-border-2" className={`animate__animated animate__fadeInDown flex items-center p-2 mb-2 text-red-800 border-s-4 border-red-300 bg-red-50 dark:text-red-400 dark:bg-gray-800 dark:border-red-800 rounded-lg ${Error === "" ? "hidden":""} `} role="alert">
            ...
            <button onClick={handleSignupSubmit} className={`w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 ${poppins.className}`}>
