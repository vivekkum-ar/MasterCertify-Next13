...
<footer className="bg-white dark:bg-gray-900">
        <div className="mx-auto w-full max-w-screen-xl sm:px-6 py-6 lg:py-8">
          <div className="flex-row md:flex md:justify-between">
            <div className="mb-6 md:mb-0 grid items-center justify-center bg-gray-200 sm:bg-white border-gray-300 sm:border-0 border-y-2">
          ...
          <div className="flex flex-col sm:flex-row items-center sm:justify-between">
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="/" className="hover:underline">MasterCertify™</a>. All Rights Reserved.
            </span>
