  ...
  return (
    <section className="newmorph ">
        ...
        <div className="py-0 mx-auto max-w-screen-xl row-span-2 sm:row-span-0 sm:col-span-2">
          <div className="bg-gray-200 bg-clip-padding bg-opacity-60 backdrop-filter backdrop-blur-lg dark:bg-gray-500 dark:bg-opacity-70 dark:text-white border border-white rounded-xl
           pasdasd-8 md:my-4 py-4 md:p-4">
